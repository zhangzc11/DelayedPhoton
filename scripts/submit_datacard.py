...
if __name__ == "__main__":
	...
	with open(sig_list_filename,"r") as sig_list_file:
		for this_sig in sig_list_file:
			...
			env_script_f.write("./Fit2D "+inputData+" "+inputSigDir+"GMSB_"+sig_array[0]+"_13TeV-pythia8.root "+'"'+sig_array[0]+'" '+'"'+sig_array[1]+'" 3J datacard \n')
			env_script_f.write("cd "+ work_directory +"fit_results/datacards_3J \n")
			...
			env_script_f.write("cd " + work_directory + "\n")
			env_script_f.write("./Fit2D "+inputData+" "+inputSigDir+"GMSB_"+sig_array[0]+"_13TeV-pythia8.root "+'"'+sig_array[0]+'" '+'"'+sig_array[1]+'" 2J datacard \n')
	
			env_script_f.write("cd "+ work_directory +"fit_results/datacards_2J \n")
			env_script_f.write('echo "L100TeV_Ctau1000cm limits below (2J):" \n')
			env_script_f.write("combine DelayedPhotonCard_"+sig_array[0]+".txt -M Asymptotic -n "+sig_array[0]+"\n")
	
			
			env_script_f.write('echo "combining 2J and 3J datacards:" \n')
			env_script_f.write("mkdir -p "+ work_directory +"fit_results/datacards \n")
			env_script_f.write("cd "+ work_directory +"fit_results/datacards \n")
			env_script_f.write("combineCards.py ch2J=../datacards_2J/DelayedPhotonCard_"+sig_array[0]+".txt ch3J=../datacards_3J/DelayedPhotonCard_"+sig_array[0]+".txt > DelayedPhotonCard_"+sig_array[0]+".txt \n")	
