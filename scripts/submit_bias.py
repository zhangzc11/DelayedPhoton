	...
	with open(sig_list_filename,"r") as sig_list_file:
		for this_sig in sig_list_file:
			...
			for SoverB_index in range(len(SoverB)):
				...
				env_script_f.write("./Fit2D "+inputData+" "+inputSigDir+"GMSB_"+sig_array[0]+"_13TeV-pythia8.root "+'"'+sig_array[0]+'" '+'"'+sig_array[1]+'" 3J bias '+SoverB[SoverB_index]+' '+ntoys+'\n')
				env_script_f.write('echo "running on category 2J ======= " \n')
				env_script_f.write("./Fit2D "+inputData+" "+inputSigDir+"GMSB_"+sig_array[0]+"_13TeV-pythia8.root "+'"'+sig_array[0]+'" '+'"'+sig_array[1]+'" 2J bias '+SoverB[SoverB_index]+' '+ntoys+'\n')
