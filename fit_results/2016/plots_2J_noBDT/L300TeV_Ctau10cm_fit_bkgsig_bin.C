...
//=========  (Fri Jan 18 00:24:41 2019) by ROOT version6.06/09
   ...
   TH1D *frame_83cc310__3 = new TH1D("frame_83cc310__3","",30,0,30);
   frame_83cc310__3->SetBinContent(1,74787.27);
   frame_83cc310__3->SetMinimum(0.001);
   frame_83cc310__3->SetMaximum(7.478727e+07);
   frame_83cc310__3->SetEntries(1);
   frame_83cc310__3->SetDirectory(0);
   frame_83cc310__3->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   frame_83cc310__3->SetLineColor(ci);
   frame_83cc310__3->GetXaxis()->SetTitle("2D bin");
   frame_83cc310__3->GetXaxis()->SetLabelFont(42);
   frame_83cc310__3->GetXaxis()->SetLabelSize(0.035);
   frame_83cc310__3->GetXaxis()->SetTitleSize(0.035);
   frame_83cc310__3->GetXaxis()->SetTitleFont(42);
   frame_83cc310__3->GetYaxis()->SetTitle("Events / ( 1 )");
   frame_83cc310__3->GetYaxis()->SetLabelFont(42);
   frame_83cc310__3->GetYaxis()->SetLabelSize(0.035);
   frame_83cc310__3->GetYaxis()->SetTitleSize(0.035);
   frame_83cc310__3->GetYaxis()->SetTitleFont(42);
   frame_83cc310__3->GetZaxis()->SetLabelFont(42);
   frame_83cc310__3->GetZaxis()->SetLabelSize(0.035);
   frame_83cc310__3->GetZaxis()->SetTitleSize(0.035);
   frame_83cc310__3->GetZaxis()->SetTitleFont(42);
   frame_83cc310__3->Draw("FUNC");
   ...
   Graph_bin_Sig5->SetMinimum(1.357469e-09);
   Graph_bin_Sig5->SetMaximum(1.357469e-06);
   ...
   TH1D *frame_83cc310__4 = new TH1D("frame_83cc310__4","",30,0,30);
   frame_83cc310__4->SetBinContent(1,74787.27);
   frame_83cc310__4->SetMinimum(0.001);
   frame_83cc310__4->SetMaximum(7.478727e+07);
   frame_83cc310__4->SetEntries(1);
   frame_83cc310__4->SetDirectory(0);
   frame_83cc310__4->SetStats(0);

   ci = TColor::GetColor("#000099");
   frame_83cc310__4->SetLineColor(ci);
   frame_83cc310__4->GetXaxis()->SetTitle("2D bin");
   frame_83cc310__4->GetXaxis()->SetLabelFont(42);
   frame_83cc310__4->GetXaxis()->SetLabelSize(0.035);
   frame_83cc310__4->GetXaxis()->SetTitleSize(0.035);
   frame_83cc310__4->GetXaxis()->SetTitleFont(42);
   frame_83cc310__4->GetYaxis()->SetTitle("Events / ( 1 )");
   frame_83cc310__4->GetYaxis()->SetLabelFont(42);
   frame_83cc310__4->GetYaxis()->SetLabelSize(0.035);
   frame_83cc310__4->GetYaxis()->SetTitleSize(0.035);
   frame_83cc310__4->GetYaxis()->SetTitleFont(42);
   frame_83cc310__4->GetZaxis()->SetLabelFont(42);
   frame_83cc310__4->GetZaxis()->SetLabelSize(0.035);
   frame_83cc310__4->GetZaxis()->SetTitleSize(0.035);
   frame_83cc310__4->GetZaxis()->SetTitleFont(42);
   frame_83cc310__4->Draw("AXISSAME");
