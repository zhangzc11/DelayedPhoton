...
if __name__ == "__main__":
	...
	with open(sig_list_filename,"r") as sig_list_file:
		for this_sig in sig_list_file:
			...
			minsize = 1000
			actualsize = 0
			if os.path.isfile("/mnt/hadoop/store/group/phys_susy/razor/Run2Analysis/DelayedPhotonAnalysis/2016/orderByPt/fit_results/2016ABCD_binAndDatacard/datacards_3J_noBDT/higgsCombine"+sig_array[0]+".Asymptotic.mH120.root"):
				actualsize =os.path.getsize("/mnt/hadoop/store/group/phys_susy/razor/Run2Analysis/DelayedPhotonAnalysis/2016/orderByPt/fit_results/2016ABCD_binAndDatacard/datacards_3J_noBDT/higgsCombine"+sig_array[0]+".Asymptotic.mH120.root")
