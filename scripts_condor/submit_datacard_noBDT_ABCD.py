...
if __name__ == "__main__":
	...
	#os.system("hadoop fs -rm -r "+outputDir+version)
	...
	with open(sig_list_filename,"r") as sig_list_file:
		for this_sig in sig_list_file:
			...
			env_script_f.write("env -i X509_USER_PROXY=${x509loc} gfal-copy -f --checksum-mode=both fitABCD_"+sig_array[0]+".tar gsiftp://transfer.ultralight.org/"+outputDir+version+"/"+sig_array[0]+".tar \n")
