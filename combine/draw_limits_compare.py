...
r_exp_p1sig_2d_grid_v1 = np.zeros((N_ctau, N_lambda))
r_exp_m1sig_2d_grid_v1 = np.zeros((N_ctau, N_lambda))
r_obs_2d_grid_v1 = np.zeros((N_ctau, N_lambda))

r_exp_2d_grid_v2 = np.zeros((N_ctau, N_lambda))
r_exp_p1sig_2d_grid_v2 = np.zeros((N_ctau, N_lambda))
r_exp_m1sig_2d_grid_v2 = np.zeros((N_ctau, N_lambda))
...
for ctau_this in ctau_points:
	...
	limit_this_v1_exp2p5 = []
	limit_this_v1_exp16p0 = []
	limit_this_v1_exp50p0 = []
	limit_this_v1_exp84p0 = []
	limit_this_v1_exp97p5 = []
	limit_this_v1_obs = []

	limit_this_v2_exp2p5 = []
	limit_this_v2_exp16p0 = []
	limit_this_v2_exp50p0 = []
	limit_this_v2_exp84p0 = []
	limit_this_v2_exp97p5 = []
	limit_this_v2_obs = []

	
	yValue_limit_this_v1_exp = []
	yValue_limit_this_v1_obs = []
	yValue_limit_this_v1_exp1sigma = []
	yValue_limit_this_v1_exp2sigma = []
	
	yValue_limit_this_v2_exp = []
	yValue_limit_this_v2_obs = []
	yValue_limit_this_v2_exp1sigma = []
	yValue_limit_this_v2_exp2sigma = []
	...
	for lambda_this in lambda_points:
		...
		if actualsize_v1 > minsize and actualsize_v2 > minsize:
			...
			if len(limits_v1) < 6 or len(limits_v2) < 6:
				continue
			...
			limit_this_v2_exp2p5.append(limits_v2[0]*th_xsec_this)	
			limit_this_v2_exp16p0.append(limits_v2[1]*th_xsec_this)	
			limit_this_v2_exp50p0.append(limits_v2[2]*th_xsec_this)	
			limit_this_v2_exp84p0.append(limits_v2[3]*th_xsec_this)	
			limit_this_v2_exp97p5.append(limits_v2[4]*th_xsec_this)	
			limit_this_v2_obs.append(limits_v2[5]*th_xsec_this)	

			limit_this_v1_exp2p5.append(limits_v1[0]*th_xsec_this)	
			limit_this_v1_exp16p0.append(limits_v1[1]*th_xsec_this)	
			limit_this_v1_exp50p0.append(limits_v1[2]*th_xsec_this)	
			limit_this_v1_exp84p0.append(limits_v1[3]*th_xsec_this)	
			limit_this_v1_exp97p5.append(limits_v1[4]*th_xsec_this)	
			limit_this_v1_obs.append(limits_v1[5]*th_xsec_this)	

			r_exp_2d_grid_v1[index_ctau][index_lambda] = limits_v1[2]
			r_exp_p1sig_2d_grid_v1[index_ctau][index_lambda] = limits_v1[3]
			r_exp_m1sig_2d_grid_v1[index_ctau][index_lambda] = limits_v1[1]
			r_obs_2d_grid_v1[index_ctau][index_lambda] = limits_v1[5]

			r_exp_2d_grid_v2[index_ctau][index_lambda] = limits_v2[2]
			r_exp_p1sig_2d_grid_v2[index_ctau][index_lambda] = limits_v2[3]
			r_exp_m1sig_2d_grid_v2[index_ctau][index_lambda] = limits_v2[1]
			r_obs_2d_grid_v2[index_ctau][index_lambda] = limits_v2[5]
	...
	for i in range(0, NPoints_mass):
		...
		yValue_limit_this_v1_exp1sigma.append(limit_this_v1_exp16p0[i])
		yValue_limit_this_v1_exp2sigma.append(limit_this_v1_exp2p5[i])
			
		yValue_limit_this_v2_obs.append(limit_this_v2_obs[i])
		yValue_limit_this_v2_exp.append(limit_this_v2_exp50p0[i])
		yValue_limit_this_v2_exp1sigma.append(limit_this_v2_exp16p0[i])
		yValue_limit_this_v2_exp2sigma.append(limit_this_v2_exp2p5[i])
		
	for i in range(0, NPoints_mass):
		xValue_mass_exp1sigma.append(xValue_mass[NPoints_mass-i-1])
		xValue_mass_exp2sigma.append(xValue_mass[NPoints_mass-i-1])
		
		yValue_limit_this_v1_exp1sigma.append(limit_this_v1_exp84p0[NPoints_mass-i-1])
		yValue_limit_this_v1_exp2sigma.append(limit_this_v1_exp97p5[NPoints_mass-i-1])

		yValue_limit_this_v2_exp1sigma.append(limit_this_v2_exp84p0[NPoints_mass-i-1])
		yValue_limit_this_v2_exp2sigma.append(limit_this_v2_exp97p5[NPoints_mass-i-1])
	...
	graph_limit_vs_mass_v1_exp1sigma_limit = TGraph(2*NPoints_mass, np.array(xValue_mass_exp1sigma), np.array(yValue_limit_this_v1_exp1sigma))
	graph_limit_vs_mass_v1_exp2sigma_limit = TGraph(2*NPoints_mass, np.array(xValue_mass_exp2sigma), np.array(yValue_limit_this_v1_exp2sigma))
	...
	graph_limit_vs_mass_v1_exp1sigma_limit.SetFillColor(kGreen)
	graph_limit_vs_mass_v1_exp2sigma_limit.SetFillColor(kYellow)
	...
	graph_limit_vs_mass_v1_exp2sigma_limit.Draw("Fsame")
	graph_limit_vs_mass_v1_exp1sigma_limit.Draw("Fsame")
	if drawObs:
	...
	leg_limit_vs_mass_v1.AddEntry(graph_limit_vs_mass_v1_exp1sigma_limit, "#pm 1 #sigma Expected", "F")
	...
	graph_limit_vs_mass_v2_exp1sigma_limit = TGraph(2*NPoints_mass, np.array(xValue_mass_exp1sigma), np.array(yValue_limit_this_v2_exp1sigma))
	graph_limit_vs_mass_v2_exp2sigma_limit = TGraph(2*NPoints_mass, np.array(xValue_mass_exp2sigma), np.array(yValue_limit_this_v2_exp2sigma))
	...
	graph_limit_vs_mass_v2_exp1sigma_limit.SetFillColor(kGreen)
	graph_limit_vs_mass_v2_exp2sigma_limit.SetFillColor(kYellow)
	...
	graph_limit_vs_mass_v2_exp2sigma_limit.Draw("Fsame")
	graph_limit_vs_mass_v2_exp1sigma_limit.Draw("Fsame")
	if drawObs:
	...
	leg_limit_vs_mass_v2.AddEntry(graph_limit_vs_mass_v2_exp1sigma_limit, "#pm 1 #sigma Expected", "F")
...
lambda_point_boundary_exp_p1sig_v1 = np.zeros(N_ctau)
lambda_point_boundary_exp_m1sig_v1 = np.zeros(N_ctau)
lambda_point_boundary_obs_v1 = np.zeros(N_ctau)

lambda_point_boundary_exp_v2 = np.zeros(N_ctau)
lambda_point_boundary_exp_p1sig_v2 = np.zeros(N_ctau)
lambda_point_boundary_exp_m1sig_v2 = np.zeros(N_ctau)
...
for i in range(0, N_ctau):
	...
	lambda_interp_v1 = []
	r_exp_interp_v1 = []
	r_exp_p1sig_interp_v1 = []
	r_exp_m1sig_interp_v1 = []
	r_obs_interp_v1 = []
	...
	for j in range(0, N_lambda):
		if r_exp_2d_grid_v1[i][j] > 0.00000001:
			...
			r_exp_p1sig_interp_v1.append(r_exp_p1sig_2d_grid_v1[i][j]*1.0)
			r_exp_m1sig_interp_v1.append(r_exp_m1sig_2d_grid_v1[i][j]*1.0)
	...
	graph_lambda_vs_r_exp_p1sig_v1 =  TGraph(len(lambda_interp_v1), np.array(r_exp_p1sig_interp_v1), np.array(lambda_interp_v1))
	graph_lambda_vs_r_exp_m1sig_v1 =  TGraph(len(lambda_interp_v1), np.array(r_exp_m1sig_interp_v1), np.array(lambda_interp_v1))
	lambda_point_boundary_exp_v1[i] = graph_lambda_vs_r_exp_v1.Eval(1.0)
	lambda_point_boundary_exp_p1sig_v1[i] = graph_lambda_vs_r_exp_p1sig_v1.Eval(1.0)
	lambda_point_boundary_exp_m1sig_v1[i] = graph_lambda_vs_r_exp_m1sig_v1.Eval(1.0)
	...
	lambda_interp_v2 = []
	r_exp_interp_v2 = []
	r_exp_p1sig_interp_v2 = []
	r_exp_m1sig_interp_v2 = []
	r_obs_interp_v2 = []
	...
	for j in range(0, N_lambda):
		if r_exp_2d_grid_v2[i][j] > 0.00000001:
			...
			r_exp_p1sig_interp_v2.append(r_exp_p1sig_2d_grid_v2[i][j]*1.0)
			r_exp_m1sig_interp_v2.append(r_exp_m1sig_2d_grid_v2[i][j]*1.0)
	...
	graph_lambda_vs_r_exp_p1sig_v2 =  TGraph(len(lambda_interp_v2), np.array(r_exp_p1sig_interp_v2), np.array(lambda_interp_v2))
	graph_lambda_vs_r_exp_m1sig_v2 =  TGraph(len(lambda_interp_v2), np.array(r_exp_m1sig_interp_v2), np.array(lambda_interp_v2))
	lambda_point_boundary_exp_v2[i] = graph_lambda_vs_r_exp_v2.Eval(1.0)
	lambda_point_boundary_exp_p1sig_v2[i] = graph_lambda_vs_r_exp_p1sig_v2.Eval(1.0)
	lambda_point_boundary_exp_m1sig_v2[i] = graph_lambda_vs_r_exp_m1sig_v2.Eval(1.0)
...
print "exp p1sig (v1) exclusion lambda boundary for different ctau:"
print lambda_point_boundary_exp_p1sig_v1
print "exp m1sig (v1) exclusion lambda boundary for different ctau:"
print lambda_point_boundary_exp_m1sig_v1
...
print "exp p1sig (v2) exclusion lambda boundary for different ctau:"
print lambda_point_boundary_exp_p1sig_v2
print "exp m1sig (v2) exclusion lambda boundary for different ctau:"
print lambda_point_boundary_exp_m1sig_v2
...
lambda_point_boundary_exp_pm1sig_v1 = []
lambda_point_boundary_exp_pm1sig_v2 = []
ctau_points_loop = []

for i in range(0,len(ctau_points)):
	ctau_points_loop.append(ctau_points[i])
	lambda_point_boundary_exp_pm1sig_v1.append(lambda_point_boundary_exp_p1sig_v1[i]*1.0)
	lambda_point_boundary_exp_pm1sig_v2.append(lambda_point_boundary_exp_p1sig_v2[i]*1.0)

for i in range(0, len(ctau_points)):
	ctau_points_loop.append(ctau_points[len(ctau_points)-i-1]*1.0) 
	lambda_point_boundary_exp_pm1sig_v1.append(lambda_point_boundary_exp_m1sig_v1[len(ctau_points)-i-1]*1.0)
	lambda_point_boundary_exp_pm1sig_v2.append(lambda_point_boundary_exp_m1sig_v2[len(ctau_points)-i-1]*1.0)
...
graph_exclusion_exp_p1sig_v1 = TGraph(len(lambda_point_boundary_exp_p1sig_v1), np.array(1.454*lambda_point_boundary_exp_p1sig_v1-6.0), np.array(ctau_points))
graph_exclusion_exp_m1sig_v1 = TGraph(len(lambda_point_boundary_exp_m1sig_v1), np.array(1.454*lambda_point_boundary_exp_m1sig_v1-6.0), np.array(ctau_points))
graph_exclusion_exp_pm1sig_v1 = TGraph(len(lambda_point_boundary_exp_pm1sig_v1), np.array(1.454*np.array(lambda_point_boundary_exp_pm1sig_v1)-6.0), np.array(ctau_points_loop))
...
graph_exclusion_exp_p1sig_v1.SetLineColor(kOrange - 9)
graph_exclusion_exp_p1sig_v1.SetLineWidth(2)
graph_exclusion_exp_p1sig_v1.SetLineStyle(kDashed)

graph_exclusion_exp_m1sig_v1.SetMarkerStyle(19)
graph_exclusion_exp_m1sig_v1.SetMarkerSize(0.0)
graph_exclusion_exp_m1sig_v1.SetLineColor(kOrange - 9)
graph_exclusion_exp_m1sig_v1.SetLineWidth(2)
graph_exclusion_exp_m1sig_v1.SetLineStyle(kDashed)

graph_exclusion_exp_pm1sig_v1.SetFillColorAlpha(kOrange - 9, 0.65)
graph_exclusion_exp_pm1sig_v1.SetFillStyle(3353)
...
graph_exclusion_exp_p1sig_v2 = TGraph(len(lambda_point_boundary_exp_p1sig_v2), np.array(1.454*lambda_point_boundary_exp_p1sig_v2-6.0), np.array(ctau_points))
graph_exclusion_exp_m1sig_v2 = TGraph(len(lambda_point_boundary_exp_m1sig_v2), np.array(1.454*lambda_point_boundary_exp_m1sig_v2-6.0), np.array(ctau_points))
graph_exclusion_exp_pm1sig_v2 = TGraph(len(lambda_point_boundary_exp_pm1sig_v2), np.array(1.454*np.array(lambda_point_boundary_exp_pm1sig_v2)-6.0), np.array(ctau_points_loop))
...
graph_exclusion_exp_p1sig_v2.SetLineColor(kOrange - 9)
graph_exclusion_exp_p1sig_v2.SetLineWidth(2)
graph_exclusion_exp_p1sig_v2.SetLineStyle(kDashed)

graph_exclusion_exp_m1sig_v2.SetMarkerStyle(19)
graph_exclusion_exp_m1sig_v2.SetMarkerSize(0.0)
graph_exclusion_exp_m1sig_v2.SetLineColor(kOrange - 9)
graph_exclusion_exp_m1sig_v2.SetLineWidth(2)
graph_exclusion_exp_m1sig_v2.SetLineStyle(kDashed)

graph_exclusion_exp_pm1sig_v2.SetFillColorAlpha(kOrange - 9, 0.65)
graph_exclusion_exp_pm1sig_v2.SetFillStyle(3353)
...
graph_exclusion_exp_p1sig_v1.SetLineColor(kGray+1)
graph_exclusion_exp_m1sig_v1.SetLineColor(kGray+1)
...
graph_exclusion_exp_p1sig_v2.SetLineColor(4)
graph_exclusion_exp_m1sig_v2.SetLineColor(4)
...
#graph_exclusion_exp_m1sig_v2.Draw("Lsame")
#graph_exclusion_exp_pm1sig_v2.Draw("Fsame")
graph_exclusion_exp_v1.Draw("Lsame")
#graph_exclusion_exp_p1sig_v1.Draw("Lsame")
#graph_exclusion_exp_m1sig_v1.Draw("Lsame")
#graph_exclusion_exp_pm1sig_v1.Draw("Fsame")
if drawObs:
