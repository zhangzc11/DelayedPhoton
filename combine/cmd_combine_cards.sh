...
do
	...
	do
		...
		echo "combineCards.py ch2016=${cards_2016_dir}/DelayedPhotonCard_L${lambda}TeV_Ctau${ctau_2016}cm.txt ch2017=${cards_2017_dir}/datacardABCD_GMSB_L${lambda}_CTau${ctau}.txt > combine/datacard_GMSB_L${lambda}TeV_CTau${ctau}cm_2016And2017.txt -v 2"	
