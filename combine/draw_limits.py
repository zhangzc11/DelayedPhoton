...
for ctau_this in ctau_points:
	...
	myC.SaveAs(outputDir+"/limits"+"/limit_vs_mass_2016_ctau"+ctau_this_str+".pdf")
	myC.SaveAs(outputDir+"/limits"+"/limit_vs_mass_2016_ctau"+ctau_this_str+".png")
	myC.SaveAs(outputDir+"/limits"+"/limit_vs_mass_2016_ctau"+ctau_this_str+".C")
	...
	myC.SaveAs(outputDir+"/limits"+"/limit_vs_mass_2017_ctau"+ctau_this_str+".pdf")
	myC.SaveAs(outputDir+"/limits"+"/limit_vs_mass_2017_ctau"+ctau_this_str+".png")
	myC.SaveAs(outputDir+"/limits"+"/limit_vs_mass_2017_ctau"+ctau_this_str+".C")
	...
	myC.SaveAs(outputDir+"/limits"+"/limit_vs_mass_2016And2017_ctau"+ctau_this_str+".pdf")
	myC.SaveAs(outputDir+"/limits"+"/limit_vs_mass_2016And2017_ctau"+ctau_this_str+".png")
	myC.SaveAs(outputDir+"/limits"+"/limit_vs_mass_2016And2017_ctau"+ctau_this_str+".C")
	...
	myC.SaveAs(outputDir+"/limits"+"/limit_vs_mass_2016_2017_ctau"+ctau_this_str+".pdf")
	myC.SaveAs(outputDir+"/limits"+"/limit_vs_mass_2016_2017_ctau"+ctau_this_str+".png")
	myC.SaveAs(outputDir+"/limits"+"/limit_vs_mass_2016_2017_ctau"+ctau_this_str+".C")
...
myC2D.SaveAs(outputDir+"/limits"+"/limit_exclusion_region_2D_2016.pdf")
myC2D.SaveAs(outputDir+"/limits"+"/limit_exclusion_region_2D_2016.png")
myC2D.SaveAs(outputDir+"/limits"+"/limit_exclusion_region_2D_2016.C")
...
graph_exclusion_exp_2017.SetLineColor(kOrange - 9)
...
####legend
leg_2d_exclusion_2017 = TLegend(0.25,0.64,0.92,0.91)
...
myC2D.SaveAs(outputDir+"/limits"+"/limit_exclusion_region_2D_2017.pdf")
myC2D.SaveAs(outputDir+"/limits"+"/limit_exclusion_region_2D_2017.png")
myC2D.SaveAs(outputDir+"/limits"+"/limit_exclusion_region_2D_2017.C")
...
graph_exclusion_exp_2016And2017.SetLineColor(kOrange - 9)
...
####legend
leg_2d_exclusion_2016And2017 = TLegend(0.25,0.64,0.92,0.91)
...
myC2D.SaveAs(outputDir+"/limits"+"/limit_exclusion_region_2D_2016And2017.pdf")
myC2D.SaveAs(outputDir+"/limits"+"/limit_exclusion_region_2D_2016And2017.png")
myC2D.SaveAs(outputDir+"/limits"+"/limit_exclusion_region_2D_2016And2017.C")


###overlay 2017 and 2017

graph_exclusion_exp_2016.SetMarkerStyle(19)
graph_exclusion_exp_2016.SetLineColor(kGray+1)
graph_exclusion_exp_2016.SetFillColorAlpha(kGray+1, 0.85)
...
graph_exclusion_exp_2017.SetMarkerStyle(19)
graph_exclusion_exp_2017.SetLineColor(4)
graph_exclusion_exp_2017.SetFillColorAlpha(4, 0.65)
...
graph_exclusion_exp_2016And2017.SetMarkerStyle(19)
graph_exclusion_exp_2016And2017.SetLineColor(kPink)
graph_exclusion_exp_2016And2017.SetFillColorAlpha(kPink, 0.65)
graph_exclusion_exp_2016And2017.SetFillStyle(3344)
graph_exclusion_exp_p1sig_2016And2017.SetLineColor(kPink)
graph_exclusion_exp_m1sig_2016And2017.SetLineColor(kPink)
graph_exclusion_exp_pm1sig_2016And2017.SetFillColorAlpha(kPink, 0.65)
...
####legend
leg_2d_exclusion_2016_2017 = TLegend(0.25,0.64,0.92,0.91)
...
myC2D.SaveAs(outputDir+"/limits"+"/limit_exclusion_region_2D_2016_2017.pdf")
myC2D.SaveAs(outputDir+"/limits"+"/limit_exclusion_region_2D_2016_2017.png")
myC2D.SaveAs(outputDir+"/limits"+"/limit_exclusion_region_2D_2016_2017.C")
