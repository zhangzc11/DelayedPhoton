...
for ctau_this in ctau_points:
	...
	for lambda_this in lambda_points:
		...
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016_Observed.HybridNew.mH120.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016_Exp0p025.HybridNew.mH120.quant0.025.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016_Exp0p16.HybridNew.mH120.quant0.160.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016_Exp0p5.HybridNew.mH120.quant0.500.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016_Exp0p84.HybridNew.mH120.quant0.840.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016_Exp0p975.HybridNew.mH120.quant0.975.root"):
			continue
		...
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT1_Observed.HybridNew.mH120.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT1_Exp0p025.HybridNew.mH120.quant0.025.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT1_Exp0p16.HybridNew.mH120.quant0.160.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT1_Exp0p5.HybridNew.mH120.quant0.500.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT1_Exp0p84.HybridNew.mH120.quant0.840.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT1_Exp0p975.HybridNew.mH120.quant0.975.root"):
			continue
		...
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT2_Observed.HybridNew.mH120.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT2_Exp0p025.HybridNew.mH120.quant0.025.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT2_Exp0p16.HybridNew.mH120.quant0.160.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT2_Exp0p5.HybridNew.mH120.quant0.500.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT2_Exp0p84.HybridNew.mH120.quant0.840.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT2_Exp0p975.HybridNew.mH120.quant0.975.root"):
			continue
		...
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017_Observed.HybridNew.mH120.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017_Exp0p025.HybridNew.mH120.quant0.025.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017_Exp0p16.HybridNew.mH120.quant0.160.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017_Exp0p5.HybridNew.mH120.quant0.500.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017_Exp0p84.HybridNew.mH120.quant0.840.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017_Exp0p975.HybridNew.mH120.quant0.975.root"):
			continue
		...
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016And2017_Observed.HybridNew.mH120.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016And2017_Exp0p025.HybridNew.mH120.quant0.025.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016And2017_Exp0p16.HybridNew.mH120.quant0.160.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016And2017_Exp0p5.HybridNew.mH120.quant0.500.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016And2017_Exp0p84.HybridNew.mH120.quant0.840.root"):
			continue
		if not os.path.isfile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016And2017_Exp0p975.HybridNew.mH120.quant0.975.root"):
			continue
		...
		limits_2016 = []
		file_limit_2016_exp0p025 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016_Exp0p025.HybridNew.mH120.quant0.025.root")
		file_limit_2016_exp0p16 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016_Exp0p16.HybridNew.mH120.quant0.160.root")
		...
		file_limit_2016_exp0p84 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016_Exp0p84.HybridNew.mH120.quant0.840.root")
		file_limit_2016_exp0p975 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016_Exp0p975.HybridNew.mH120.quant0.975.root")
		...
		limitTree_2016_exp0p025 = file_limit_2016_exp0p025.Get("limit")
		limitTree_2016_exp0p16 = file_limit_2016_exp0p16.Get("limit")
		limitTree_2016_exp0p5 = file_limit_2016_exp0p5.Get("limit")
		limitTree_2016_exp0p84 = file_limit_2016_exp0p84.Get("limit")
		limitTree_2016_exp0p975 = file_limit_2016_exp0p975.Get("limit")
		limitTree_2016_obs = file_limit_2016_obs.Get("limit")
		for entry in limitTree_2016_exp0p025:
			limits_2016.append(entry.limit)
		for entry in limitTree_2016_exp0p16:
			limits_2016.append(entry.limit)
		for entry in limitTree_2016_exp0p5:
			limits_2016.append(entry.limit)
		for entry in limitTree_2016_exp0p84:
			limits_2016.append(entry.limit)
		for entry in limitTree_2016_exp0p975:
			limits_2016.append(entry.limit)
		...
		limits_2017 = []
		file_limit_2017_exp0p025 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017_Exp0p025.HybridNew.mH120.quant0.025.root")
		file_limit_2017_exp0p16 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017_Exp0p16.HybridNew.mH120.quant0.160.root")
		...
		file_limit_2017_exp0p84 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017_Exp0p84.HybridNew.mH120.quant0.840.root")
		file_limit_2017_exp0p975 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017_Exp0p975.HybridNew.mH120.quant0.975.root")
		...
		limitTree_2017_exp0p025 = file_limit_2017_exp0p025.Get("limit")
		limitTree_2017_exp0p16 = file_limit_2017_exp0p16.Get("limit")
		limitTree_2017_exp0p5 = file_limit_2017_exp0p5.Get("limit")
		limitTree_2017_exp0p84 = file_limit_2017_exp0p84.Get("limit")
		limitTree_2017_exp0p975 = file_limit_2017_exp0p975.Get("limit")
		limitTree_2017_obs = file_limit_2017_obs.Get("limit")
		for entry in limitTree_2017_exp0p025:
			limits_2017.append(entry.limit)
		for entry in limitTree_2017_exp0p16:
			limits_2017.append(entry.limit)
		for entry in limitTree_2017_exp0p5:
			limits_2017.append(entry.limit)
		for entry in limitTree_2017_exp0p84:
			limits_2017.append(entry.limit)
		for entry in limitTree_2017_exp0p975:
			limits_2017.append(entry.limit)
		...
		limits_2017CAT1 = []
		file_limit_2017CAT1_exp0p025 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT1_Exp0p025.HybridNew.mH120.quant0.025.root")
		file_limit_2017CAT1_exp0p16 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT1_Exp0p16.HybridNew.mH120.quant0.160.root")
		...
		file_limit_2017CAT1_exp0p84 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT1_Exp0p84.HybridNew.mH120.quant0.840.root")
		file_limit_2017CAT1_exp0p975 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT1_Exp0p975.HybridNew.mH120.quant0.975.root")
		...
		limitTree_2017CAT1_exp0p025 = file_limit_2017CAT1_exp0p025.Get("limit")
		limitTree_2017CAT1_exp0p16 = file_limit_2017CAT1_exp0p16.Get("limit")
		limitTree_2017CAT1_exp0p5 = file_limit_2017CAT1_exp0p5.Get("limit")
		limitTree_2017CAT1_exp0p84 = file_limit_2017CAT1_exp0p84.Get("limit")
		limitTree_2017CAT1_exp0p975 = file_limit_2017CAT1_exp0p975.Get("limit")
		limitTree_2017CAT1_obs = file_limit_2017CAT1_obs.Get("limit")
		for entry in limitTree_2017CAT1_exp0p025:
			limits_2017CAT1.append(entry.limit)
		for entry in limitTree_2017CAT1_exp0p16:
			limits_2017CAT1.append(entry.limit)
		for entry in limitTree_2017CAT1_exp0p5:
			limits_2017CAT1.append(entry.limit)
		for entry in limitTree_2017CAT1_exp0p84:
			limits_2017CAT1.append(entry.limit)
		for entry in limitTree_2017CAT1_exp0p975:
			limits_2017CAT1.append(entry.limit)
		...
		limits_2017CAT2 = []
		file_limit_2017CAT2_exp0p025 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT2_Exp0p025.HybridNew.mH120.quant0.025.root")
		file_limit_2017CAT2_exp0p16 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT2_Exp0p16.HybridNew.mH120.quant0.160.root")
		...
		file_limit_2017CAT2_exp0p84 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT2_Exp0p84.HybridNew.mH120.quant0.840.root")
		file_limit_2017CAT2_exp0p975 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2017CAT2_Exp0p975.HybridNew.mH120.quant0.975.root")
		...
		limitTree_2017CAT2_exp0p025 = file_limit_2017CAT2_exp0p025.Get("limit")
		limitTree_2017CAT2_exp0p16 = file_limit_2017CAT2_exp0p16.Get("limit")
		limitTree_2017CAT2_exp0p5 = file_limit_2017CAT2_exp0p5.Get("limit")
		limitTree_2017CAT2_exp0p84 = file_limit_2017CAT2_exp0p84.Get("limit")
		limitTree_2017CAT2_exp0p975 = file_limit_2017CAT2_exp0p975.Get("limit")
		limitTree_2017CAT2_obs = file_limit_2017CAT2_obs.Get("limit")
		for entry in limitTree_2017CAT2_exp0p025:
			limits_2017CAT2.append(entry.limit)
		for entry in limitTree_2017CAT2_exp0p16:
			limits_2017CAT2.append(entry.limit)
		for entry in limitTree_2017CAT2_exp0p5:
			limits_2017CAT2.append(entry.limit)
		for entry in limitTree_2017CAT2_exp0p84:
			limits_2017CAT2.append(entry.limit)
		for entry in limitTree_2017CAT2_exp0p975:
			limits_2017CAT2.append(entry.limit)
		...
		limits_2016And2017 = []
		file_limit_2016And2017_exp0p025 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016And2017_Exp0p025.HybridNew.mH120.quant0.025.root")
		file_limit_2016And2017_exp0p16 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016And2017_Exp0p16.HybridNew.mH120.quant0.160.root")
		...
		file_limit_2016And2017_exp0p84 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016And2017_Exp0p84.HybridNew.mH120.quant0.840.root")
		file_limit_2016And2017_exp0p975 = TFile(tree_dir+"/higgsCombineL"+str(lambda_this)+"TeV_CTau"+ctau_this_str+"cm_2016And2017_Exp0p975.HybridNew.mH120.quant0.975.root")
		...
		limitTree_2016And2017_exp0p025 = file_limit_2016And2017_exp0p025.Get("limit")
		limitTree_2016And2017_exp0p16 = file_limit_2016And2017_exp0p16.Get("limit")
		limitTree_2016And2017_exp0p5 = file_limit_2016And2017_exp0p5.Get("limit")
		limitTree_2016And2017_exp0p84 = file_limit_2016And2017_exp0p84.Get("limit")
		limitTree_2016And2017_exp0p975 = file_limit_2016And2017_exp0p975.Get("limit")
		limitTree_2016And2017_obs = file_limit_2016And2017_obs.Get("limit")
		for entry in limitTree_2016And2017_exp0p025:
			limits_2016And2017.append(entry.limit)
		for entry in limitTree_2016And2017_exp0p16:
			limits_2016And2017.append(entry.limit)
		for entry in limitTree_2016And2017_exp0p5:
			limits_2016And2017.append(entry.limit)
		for entry in limitTree_2016And2017_exp0p84:
			limits_2016And2017.append(entry.limit)
		for entry in limitTree_2016And2017_exp0p975:
			limits_2016And2017.append(entry.limit)
		...
		if len(limits_2016) < 6 or len(limits_2017) < 6 or len(limits_2016And2017) < 6 or len(limits_2017CAT1) < 6 or len(limits_2017CAT2) < 6:
			continue
...
leg_2d_exclusion_2017CAT1.AddEntry(graph_exclusion_exp_2017CAT1, "CMS Exp (#pm 1#sigma) 13 TeV #gamma (2017)", "LF")
if drawObs:
...
leg_2d_exclusion_2017CAT2.AddEntry(graph_exclusion_exp_2017CAT2, "CMS Exp (#pm 1#sigma) 13 TeV #gamma#gamma (2017)", "LF")
if drawObs:
...
####legend
leg_2d_exclusion_2016_2017 = TLegend(0.35,0.64,0.81,0.92)
...
####legend
leg_2d_exclusion_2016_2017 = TLegend(0.35,0.64,0.81,0.91)
leg_2d_exclusion_2016_2017.SetBorderSize(0)
leg_2d_exclusion_2016_2017.SetTextSize(0.03)
leg_2d_exclusion_2016_2017.SetLineColor(1)
leg_2d_exclusion_2016_2017.SetLineStyle(1)
