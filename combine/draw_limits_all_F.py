...
#####ATLAS 8TeV
lambda_atlas_8TeV_2g = np.array([82.5 , 102.5,   140,   160,   180,   200,   220, 260,  300, 302.58, 300, 260, 220, 200,  82.5])
t_atlas_8TeV_2g = np.array([ 121.81, 90.94, 46.63, 36.12, 27.18, 20.26, 14.59, 7.47, 2.6, 1.83, 1.31, 0.61, 0.39, 0.30, 0.30 ])
ctau_atlas_8TeV_2g = t_atlas_8TeV_2g * 30.0
mass_atlas_8TeV_2g = lambda_atlas_8TeV_2g*1.454 - 6.0
graph_exclusion_atlas_8TeV_2g = TGraph(15, mass_atlas_8TeV_2g, ctau_atlas_8TeV_2g)
graph_exclusion_atlas_8TeV_2g.SetLineColorAlpha(8, 0.6)
graph_exclusion_atlas_8TeV_2g.SetFillColorAlpha(8, 0.6)
#graph_exclusion_atlas_8TeV_2g.SetLineWidth(3)
#graph_exclusion_atlas_8TeV_2g.SetLineStyle(5)
graph_exclusion_atlas_8TeV_2g.Draw("Fsames")
...
leg_2d_exclusion_2016.AddEntry(graph_exclusion_atlas_8TeV_2g, "ATLAS Obs 8 TeV #gamma#gamma", "F")
...
leg_2d_exclusion_2017CAT1.AddEntry(graph_exclusion_atlas_8TeV_2g, "ATLAS Obs 8 TeV #gamma#gamma", "F")
...
leg_2d_exclusion_2017CAT2.AddEntry(graph_exclusion_atlas_8TeV_2g, "ATLAS Obs 8 TeV #gamma#gamma", "F")
...
leg_2d_exclusion_2017.AddEntry(graph_exclusion_atlas_8TeV_2g, "ATLAS Obs 8 TeV #gamma#gamma", "F")
...
#arr_lambda_point_boundary_obs_2016And2017 = np.concatenate(np.array([90.0], np.array(lambda_point_boundary_obs_2016And2017), np.array([90.0]))
#arr_ctau_points = np.concatenate(np.array([ctau_points[0]]), np.array(ctau_points), np.array([ctau_points[-1]]))
graph_exclusion_obs_2016And2017 = TGraph(len(arr_lambda_point_boundary_obs_2016And2017), np.array(1.454*arr_lambda_point_boundary_obs_2016And2017-6.0), np.array(arr_ctau_points))
...
graph_exclusion_obs_2016And2017.SetLineColorAlpha(617, 0.6)
graph_exclusion_obs_2016And2017.SetFillColorAlpha(617, 0.6)
...
if drawObs:
	graph_exclusion_obs_2016And2017.Draw("Fsames")
...
if drawObs:
	leg_2d_exclusion_2016And2017.AddEntry(graph_exclusion_obs_2016And2017, "CMS Obs 13 TeV #gamma(#gamma) (2016+2017)", "F")
leg_2d_exclusion_2016And2017.AddEntry(graph_exclusion_atlas_8TeV_2g, "ATLAS Obs 8 TeV #gamma#gamma", "F")
...
leg_2d_exclusion_2016_2017.AddEntry(graph_exclusion_atlas_8TeV_2g, "ATLAS Obs 8 TeV #gamma#gamma", "F")
