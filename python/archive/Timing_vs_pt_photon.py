...
for i in range(0, N_pt_points):
	...
	tree_QCD.Draw("pho1ClusterTime>>hist_1g_this_QCD_"+str(i), cut_1g_this)
	...
	tree_GJets.Draw("pho1ClusterTime>>hist_1g_this_GJets_"+str(i), cut_1g_this)
	...
	tree_QCD.Draw("pho1ClusterTime_SmearToData>>hist_1g_this_QCD_corr_"+str(i), cut_1g_this)
	...
	tree_GJets.Draw("pho1ClusterTime_SmearToData>>hist_1g_this_GJets_corr_"+str(i), cut_1g_this)
...
leg_mean_GJets.SetTextSize(0.03)
