...
cut_QCD_shape_iso = 'pho1Pt > 70 && abs(pho1Eta)<1.44 && pho1passIsoTight_PFClusterIso && pho1passEleVeto && pho1Sminor>0.15 && pho1Sminor<0.3 && ((pho1sumNeutralHadronEt/pho1Pt+pho1HoverE)*pho1E) < 6.0 && (HLTDecision[81] == 1) && (!pho1isPromptPhoton) && pho2passIsoLoose && pho2passEleVeto'
cut_QCD_shape = 'pho1Pt > 70 && abs(pho1Eta)<1.44 && pho1passIsoTight_PFClusterIso && pho1passEleVeto && pho1Sminor>0.15 && pho1Sminor<0.3 && ((pho1sumNeutralHadronEt/pho1Pt+pho1HoverE)*pho1E) < 6.0 && (HLTDecision[81] == 1) && (!pho1isPromptPhoton) && pho2passIsoLoose && pho2passEleVeto'

cut_GJets_shape_iso = 'pho1Pt > 70 && abs(pho1Eta)<1.44 && pho1passIsoTight_PFClusterIso && pho1passEleVeto && n_Jets > 2 && pho1Sminor>0.15 && pho1Sminor<0.3 && ((pho1sumNeutralHadronEt/pho1Pt+pho1HoverE)*pho1E) < 6.0 && (HLTDecision[81] == 1) && pho1isPromptPhoton && pho2passIsoLoose && pho2passEleVeto'
cut_GJets_shape = 'pho1Pt > 70 && abs(pho1Eta)<1.44 && pho1passIsoTight_PFClusterIso && pho1passEleVeto && n_Jets > 2 && pho1Sminor>0.15 && pho1Sminor<0.3 && ((pho1sumNeutralHadronEt/pho1Pt+pho1HoverE)*pho1E) < 6.0 && (HLTDecision[81] == 1) && pho1isPromptPhoton && pho2passIsoLoose && pho2passEleVeto'
...
cut_skim = "pho1Pt > 40 && pho1passIsoLoose && abs(pho1Eta)<1.44 && pho1passEleVeto && (HLTDecision[81] == 1 || HLTDecision[100] == 1 || HLTDecision[102]==1 || HLTDecision[92] == 1 || HLTDecision[93] == 1) && pho2passIsoLoose && pho2passEleVeto"
cut_skim_QCD = "pho1Pt > 40 && pho1passIsoLoose && abs(pho1Eta)<1.44 && pho1passEleVeto && (HLTDecision[81] == 1 || HLTDecision[100] == 1 || HLTDecision[102]==1 || HLTDecision[92] == 1 || HLTDecision[93] == 1) && pho2passIsoLoose && pho2passEleVeto"
...
limits_vs_mass.append(["L150TeV_Ctau600cm",   150.0, 212.1, 600.0,   0.083])
limits_vs_mass.append(["L200TeV_Ctau600cm",   200.0, 284.8, 600.0,   0.0098])
limits_vs_mass.append(["L250TeV_Ctau600cm",  250.0, 357.5, 600.0,  0.0015])
limits_vs_mass.append(["L300TeV_Ctau600cm",  300.0, 430.4, 600.0,  2.67e-4])
lifetime_limits_vs_mass = 600.0
...
limits_vs_mass.append(["L150TeV_Ctau5cm",   150.0, 212.1, 5.0,   0.083])
limits_vs_mass.append(["L200TeV_Ctau5cm",   200.0, 284.8, 5.0,   0.0098])
limits_vs_mass.append(["L250TeV_Ctau5cm",   250.0, 357.5, 5.0,   0.0015])
limits_vs_mass.append(["L300TeV_Ctau5cm",  300.0, 430.4, 5.0,  2.67e-4])
lifetime_limits_vs_mass = 5.0

limits_vs_mass.append(["L150TeV_Ctau50cm",   150.0, 212.1, 50.0,   0.083])
limits_vs_mass.append(["L200TeV_Ctau50cm",   200.0, 284.8, 50.0,   0.0098])
limits_vs_mass.append(["L250TeV_Ctau50cm",   250.0, 357.5, 50.0,   0.0015])
limits_vs_mass.append(["L300TeV_Ctau50cm",  300.0, 430.4, 50.0,  2.67e-4])
lifetime_limits_vs_mass = 50.0

limits_vs_mass.append(["L150TeV_Ctau100cm",   150.0, 212.1, 100.0,   0.083])
limits_vs_mass.append(["L200TeV_Ctau100cm",   200.0, 284.8, 100.0,   0.0098])
limits_vs_mass.append(["L250TeV_Ctau100cm",   250.0, 357.5, 100.0,   0.0015])
limits_vs_mass.append(["L300TeV_Ctau100cm",  300.0, 430.4, 100.0,  2.67e-4])
lifetime_limits_vs_mass = 100.0
'''
...
grid_lifetime_exclusion_region_2D = [20000.0, 4000.0, 1200.0, 800.0, 600.0, 400.0, 200.0, 100.0, 50.0, 5.0, 0.1, 0.01, 0.0]
