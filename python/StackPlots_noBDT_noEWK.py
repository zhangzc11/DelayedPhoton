...
for plot in splots:
	...
	myC.SaveAs(outputDir+"/stack"+"/"+plot[1]+"_noEWK.pdf")
	myC.SaveAs(outputDir+"/stack"+"/"+plot[1]+"_noEWK.png")
	myC.SaveAs(outputDir+"/stack"+"/"+plot[1]+"_noEWK.C")
	...
	myC.SaveAs(outputDir+"/stack"+"/"+plot[1]+"_dataDriven_noEWK.pdf")
	myC.SaveAs(outputDir+"/stack"+"/"+plot[1]+"_dataDriven_noEWK.png")
	myC.SaveAs(outputDir+"/stack"+"/"+plot[1]+"_dataDriven_noEWK.C")
	...
	myC.SaveAs(outputDir+"/stack"+"/"+plot[1]+"_dataDriven_reweight_noEWK.pdf")
	myC.SaveAs(outputDir+"/stack"+"/"+plot[1]+"_dataDriven_reweight_noEWK.png")
	myC.SaveAs(outputDir+"/stack"+"/"+plot[1]+"_dataDriven_reweight_noEWK.C")
	...
	myC.SaveAs(outputDir+"/stack"+"/"+plot[1]+"_GJets_test_noEWK.pdf")
	myC.SaveAs(outputDir+"/stack"+"/"+plot[1]+"_GJets_test_noEWK.png")
	myC.SaveAs(outputDir+"/stack"+"/"+plot[1]+"_GJets_test_noEWK.C")
	...
	myC.SaveAs(outputDir+"/stack"+"/"+plot[1]+"_QCD_test_noEWK.pdf")
	myC.SaveAs(outputDir+"/stack"+"/"+plot[1]+"_QCD_test_noEWK.png")
	myC.SaveAs(outputDir+"/stack"+"/"+plot[1]+"_QCD_test_noEWK.C")
