...
tree_2016B.Draw("t1calib_seed-t2calib_seed>>hist_2016B",cut)
...
tree_2016C.Draw("t1calib_seed-t2calib_seed>>hist_2016C",cut)
...
tree_2016D.Draw("t1calib_seed-t2calib_seed>>hist_2016D",cut)
...
tree_2016E.Draw("t1calib_seed-t2calib_seed>>hist_2016E",cut)
...
tree_2016F.Draw("t1calib_seed-t2calib_seed>>hist_2016F",cut)
...
tree_2016G.Draw("t1calib_seed-t2calib_seed>>hist_2016G",cut)
...
tree_2016H.Draw("t1calib_seed-t2calib_seed>>hist_2016H",cut)
...
tree_2016All.Draw("t1calib_seed-t2calib_seed>>hist_2016All",cut)
...
tree_2016MC.Draw("t1calib_seed-t2calib_seed>>hist_2016MC",cut)
...
hist_2016B.Draw("E")
hist_2016B.SetTitle("")
hist_2016B.GetXaxis().SetTitle("#Delta T (e1 seed, e2 seed) / ns")
...
#tf1_doubGaus_2016B.SetParLimits(0,0.0000001,100.0000)
#tf1_doubGaus_2016B.SetParLimits(3,0.0000001,100.0000)
tf1_doubGaus_2016B.SetParLimits(2,0.1200,1.000)
tf1_doubGaus_2016B.SetParLimits(5,0.1200,1.000)
tf1_doubGaus_2016B.SetLineColor(kRed-5)
hist_2016B.Fit("tf1_doubGaus_2016B","B")
...
#tf1_doubGaus_2016C.SetParLimits(0,0.0000001,100.0000)
#tf1_doubGaus_2016C.SetParLimits(3,0.0000001,100.0000)
tf1_doubGaus_2016C.SetParLimits(2,0.1200,1.000)
tf1_doubGaus_2016C.SetParLimits(5,0.1200,1.000)
tf1_doubGaus_2016C.SetLineColor(kOrange-5)
hist_2016C.Fit("tf1_doubGaus_2016C","B")
...
#tf1_doubGaus_2016D.SetParLimits(0,0.0000001,100.0000)
#tf1_doubGaus_2016D.SetParLimits(3,0.0000001,100.0000)
tf1_doubGaus_2016D.SetParLimits(2,0.1200,1.000)
tf1_doubGaus_2016D.SetParLimits(5,0.1200,1.000)
tf1_doubGaus_2016D.SetLineColor(kYellow-5)
hist_2016D.Fit("tf1_doubGaus_2016D","B")
...
#tf1_doubGaus_2016E.SetParLimits(0,0.0000001,100.0000)
#tf1_doubGaus_2016E.SetParLimits(3,0.0000001,100.0000)
tf1_doubGaus_2016E.SetParLimits(2,0.1200,1.000)
tf1_doubGaus_2016E.SetParLimits(5,0.1200,1.000)
tf1_doubGaus_2016E.SetLineColor(kSpring-5)
hist_2016E.Fit("tf1_doubGaus_2016E","B")
...
#tf1_doubGaus_2016F.SetParLimits(0,0.0000001,100.0000)
#tf1_doubGaus_2016F.SetParLimits(3,0.0000001,100.0000)
tf1_doubGaus_2016F.SetParLimits(2,0.1200,1.000)
tf1_doubGaus_2016F.SetParLimits(5,0.1200,1.000)
tf1_doubGaus_2016F.SetLineColor(kGreen-5)
hist_2016F.Fit("tf1_doubGaus_2016F","B")
...
#tf1_doubGaus_2016G.SetParLimits(0,0.0000001,100.0000)
#tf1_doubGaus_2016G.SetParLimits(3,0.0000001,100.0000)
tf1_doubGaus_2016G.SetParLimits(2,0.1200,1.000)
tf1_doubGaus_2016G.SetParLimits(5,0.1200,1.000)
tf1_doubGaus_2016G.SetLineColor(kPink-5)
hist_2016G.Fit("tf1_doubGaus_2016G","B")
...
#tf1_doubGaus_2016H.SetParLimits(0,0.0000001,100.0000)
#tf1_doubGaus_2016H.SetParLimits(3,0.0000001,100.0000)
tf1_doubGaus_2016H.SetParLimits(2,0.1200,1.000)
tf1_doubGaus_2016H.SetParLimits(5,0.1200,1.000)
tf1_doubGaus_2016H.SetLineColor(kViolet-5)
hist_2016H.Fit("tf1_doubGaus_2016H","B")
...
#tf1_doubGaus_2016All.SetParLimits(0,0.0000001,100.0000)
#tf1_doubGaus_2016All.SetParLimits(3,0.0000001,100.0000)
tf1_doubGaus_2016All.SetParLimits(2,0.1200,1.000)
tf1_doubGaus_2016All.SetParLimits(5,0.1200,1.000)
tf1_doubGaus_2016All.SetLineColor(kBlue-5)
hist_2016All.Fit("tf1_doubGaus_2016All","B")
...
#tf1_doubGaus_2016MC.SetParLimits(0,0.0000001,100.0000)
#tf1_doubGaus_2016MC.SetParLimits(3,0.0000001,100.0000)
tf1_doubGaus_2016MC.SetParLimits(2,0.1200,1.000)
tf1_doubGaus_2016MC.SetParLimits(5,0.1200,1.000)
tf1_doubGaus_2016MC.SetLineColor(kBlack)
hist_2016MC.Fit("tf1_doubGaus_2016MC","B")
...
myC.SaveAs(outputDir+"/ZeeTiming/ZeeTiming_seed_Data_vs_MC_2016_corrT.pdf")
myC.SaveAs(outputDir+"/ZeeTiming/ZeeTiming_seed_Data_vs_MC_2016_corrT.png")
myC.SaveAs(outputDir+"/ZeeTiming/ZeeTiming_seed_Data_vs_MC_2016_corrT.C")
