...
leg.AddEntry(histSig_noSmear, "signal(Ctau200cm) - no smear")
leg.AddEntry(histSig_Smear, "signal(Ctau200cm) - after smear")
leg.AddEntry(histSig_Ctau2_noSmear, "signal(Ctau0.1cm) - no smear")
leg.AddEntry(histSig_Ctau2_Smear, "signal(Ctau0.1cm) - after smear")
leg.AddEntry(histGJets_noSmear, "#gamma + jets (MC) - no smear")
leg.AddEntry(histGJets_Smear, "#gamma + jets (MC) - after smear")
leg.AddEntry(histQCD_noSmear, "QCD (MC) - no smear")
leg.AddEntry(histQCD_Smear, "QCD (MC) - after smear")
