...
print >> f1,  "with pre-selection ($p_T>40$, $|\\eta|<1.44$, eVeto) & "+ "%.0f " % n_blindData + "(100\\%)& "+"%.2f " % n_blindSig1 + "("+"%.1f"%float(100.0*n_blindSig1/N_beforePreselection_Sig1)+"\\%) & "+ "%.2f " % n_blindSig2 + "("+"%.1f"%float(100.0*n_blindSig2/N_beforePreselection_Sig2)+"\\%) & "+ "%.2f " % n_blindSig3 + "("+"%.1f"%float(100.0*n_blindSig3/N_beforePreselection_Sig3)+"\\%) "+ "\\\\"
