...
n_photonID_SmajorData = treeData.GetEntries(cut_blind+"&&"+cut_trigger+"&&"+cut_photonID_Smajor)
...
n_photonID_HoverEData = treeData.GetEntries(cut_blind+"&&"+cut_trigger+"&&"+cut_photonID_HoverE)
...
treeSig1.Draw("NPU>>hist_photonID_SmajorSig1",weight_cut+"("+cut_trigger+"&&"+cut_photonID_Smajor+")")
...
treeSig1.Draw("NPU>>hist_photonID_HoverESig1",weight_cut+"("+cut_trigger+"&&"+cut_photonID_HoverE+")")
...
treeSig2.Draw("NPU>>hist_photonID_SmajorSig2",weight_cut+"("+cut_trigger+"&&"+cut_photonID_Smajor+")")
...
treeSig2.Draw("NPU>>hist_photonID_HoverESig2",weight_cut+"("+cut_trigger+"&&"+cut_photonID_HoverE+")")
...
treeSig3.Draw("NPU>>hist_photonID_SmajorSig3",weight_cut+"("+cut_trigger+"&&"+cut_photonID_Smajor+")")
...
treeSig3.Draw("NPU>>hist_photonID_HoverESig3",weight_cut+"("+cut_trigger+"&&"+cut_photonID_HoverE+")")
