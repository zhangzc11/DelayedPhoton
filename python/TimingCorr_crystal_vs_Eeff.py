...
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_2016.pdf")
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_2016.png")
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_2016.C")
...
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_corr_2016.pdf")
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_corr_2016.png")
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_corr_2016.C")
