...
void drawTimingICMap(TH2F * h2_map, TString label, TString title, float range){
	...
	h2_map->GetZaxis()->SetRangeUser(minZ,maxZ);
        h2_map->Draw("colz");
	myC->SaveAs(outputDir+"/ZeeTiming/IC_Timing_vs_iEta_iPhi_"+label+"_test2.pdf");
        myC->SaveAs(outputDir+"/ZeeTiming/IC_Timing_vs_iEta_iPhi_"+label+"_test2.png");
        myC->SaveAs(outputDir+"/ZeeTiming/IC_Timing_vs_iEta_iPhi_"+label+"_test2.C");
        ...
        myC->SaveAs(outputDir+"/ZeeTiming/IC_Timing_vs_iEta_iPhi_"+label+"_zoom_test2.pdf");
        myC->SaveAs(outputDir+"/ZeeTiming/IC_Timing_vs_iEta_iPhi_"+label+"_zoom_test2.png");
        myC->SaveAs(outputDir+"/ZeeTiming/IC_Timing_vs_iEta_iPhi_"+label+"_zoom_test2.C");
...
void draw1DICDiff(TH1F * h1_map, TString label, TString title){
        ...
        h1_map->Draw("");
        myC->SaveAs(outputDir+"/ZeeTiming/IC_Timing_vs_iEta_iPhi_1DDiff_"+label+"_test2.pdf");
        myC->SaveAs(outputDir+"/ZeeTiming/IC_Timing_vs_iEta_iPhi_1DDiff_"+label+"_test2.png");
        myC->SaveAs(outputDir+"/ZeeTiming/IC_Timing_vs_iEta_iPhi_1DDiff_"+label+"_test2.C");
        delete myC;
}

void TimingCalibSingleElectron_2016_iter_test2()
{
	...
	for(int iIter = 0; iIter < max_iter; iIter++){
		...
		TFile * file_start;
		if(starting_iter >= 0) file_start = new TFile(("IC_maps/IC_map_SingleElectron_2016_test2_iter"+std::to_string(starting_iter)+".root").c_str(),"READ");

		TFile * file_out;
		TFile * file_previous;
		if(!drawOnly)  file_out = new TFile(("IC_maps/IC_map_SingleElectron_2016_test2_iter"+std::to_string(iIter)+".root").c_str(),"RECREATE");
		else  file_out = new TFile(("IC_maps/IC_map_SingleElectron_2016_test2_iter"+std::to_string(iIter)+".root").c_str(),"READ");
		if(iIter > 0) file_previous = new TFile(("IC_maps/IC_map_SingleElectron_2016_test2_iter"+std::to_string(iIter-1)+".root").c_str(),"READ");
	...
	gr_IC_diff_vs_iter->GetYaxis()->SetTitleSize( axisTitleSize );
        ...
        myC->SaveAs(outputDir+"/ZeeTiming/IC_Timing_vs_iEta_iPhi_convergence_SingleElectron_test2.pdf");
        myC->SaveAs(outputDir+"/ZeeTiming/IC_Timing_vs_iEta_iPhi_convergence_SingleElectron_test2.png");
        myC->SaveAs(outputDir+"/ZeeTiming/IC_Timing_vs_iEta_iPhi_convergence_SingleElectron_test2.C");
	...
	gr_IC_residual_vs_iter->GetYaxis()->SetTitleSize( axisTitleSize );
        ...
        myC->SaveAs(outputDir+"/ZeeTiming/IC_Timing_vs_iEta_iPhi_residual_convergence_SingleElectron_test2.pdf");
        myC->SaveAs(outputDir+"/ZeeTiming/IC_Timing_vs_iEta_iPhi_residual_convergence_SingleElectron_test2.png");
        myC->SaveAs(outputDir+"/ZeeTiming/IC_Timing_vs_iEta_iPhi_residual_convergence_SingleElectron_test2.C");
