...
import os, sys
from Aux import *
from config_withBDT import fileNameData, fileNameSig, fileNameGJets, fileNameQCD, cut, cut_noDisc, splots, lumi, outputDir, xsecSig, xsecGJets, xsecQCD
...
os.system("cp StackPlots_withBDT.py "+outputDir+"/stack")
