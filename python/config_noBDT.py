...
fractionGJets = 0.759 # from fit to SigmaIetaIeta
fractionQCD = 0.241 # from fit fo SigmaIetaIeta
useFraction = True
scaleBkg = 1.0
...
outputDir = '/afs/cern.ch/user/z/zhicaiz/www/sharebox/DelayedPhoton/22May2018_noBDT/'
