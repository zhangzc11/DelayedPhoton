...
for i in range(0, N_Eeff_points):
	...
	tree_data_select.Draw("t1_seed-t1_subseed>>hist_2e_this_data_"+str(i), cut_2e_this)
	...
	tree_MC_select.Draw("t1_seed-t1_subseed>>hist_2e_this_MC_"+str(i),  "(weight*pileupWeight) * " + cut_2e_this_MC)
	...
	tree_MC_select.Draw("t1_seed_ShiftToData-t1_subseed_ShiftToData>>hist_2e_this_MC_corr_"+str(i),  "(weight*pileupWeight) * " + cut_2e_this_MC)
...
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_2016_select.pdf")
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_2016_select.png")
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_2016_select.C")
...
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_corr_2016_select.pdf")
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_corr_2016_select.png")
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_corr_2016_select.C")
