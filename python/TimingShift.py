...
os.system("cp TimingShift.py "+outputDir+"/ZeeTiming/")
#################plot settings###########################
axisTitleSize = 0.06
axisTitleOffset = .8
...
file_2016B = TFile("/mnt/hadoop/store/group/phys_susy/razor/Run2Analysis/EcalTiming/ntuples_V4p1_31Aug2018/ZeeTiming_DoubleEG_2016B.root")
...
file_2016C = TFile("/mnt/hadoop/store/group/phys_susy/razor/Run2Analysis/EcalTiming/ntuples_V4p1_31Aug2018/ZeeTiming_DoubleEG_2016C.root")
...
file_2016D = TFile("/mnt/hadoop/store/group/phys_susy/razor/Run2Analysis/EcalTiming/ntuples_V4p1_31Aug2018/ZeeTiming_DoubleEG_2016D.root")
...
file_2016E = TFile("/mnt/hadoop/store/group/phys_susy/razor/Run2Analysis/EcalTiming/ntuples_V4p1_31Aug2018/ZeeTiming_DoubleEG_2016E.root")
...
file_2016F = TFile("/mnt/hadoop/store/group/phys_susy/razor/Run2Analysis/EcalTiming/ntuples_V4p1_31Aug2018/ZeeTiming_DoubleEG_2016F.root")
...
file_2016G = TFile("/mnt/hadoop/store/group/phys_susy/razor/Run2Analysis/EcalTiming/ntuples_V4p1_31Aug2018/ZeeTiming_DoubleEG_2016G.root")
...
file_2016H = TFile("/mnt/hadoop/store/group/phys_susy/razor/Run2Analysis/EcalTiming/ntuples_V4p1_31Aug2018/ZeeTiming_DoubleEG_2016H.root")
...
file_2016MC = TFile("/mnt/hadoop/store/group/phys_susy/razor/Run2Analysis/EcalTiming/ntuples_V4p1_31Aug2018/MC2016_all.root")
...
hist_2016B.Draw("E")
hist_2016B.SetTitle("")
hist_2016B.GetXaxis().SetTitle("electron time / ns")
...
##fit
tf1_singGaus_2016B = TF1("tf1_singGaus_2016B","gaus(0)", -0.6,0.6)
tf1_singGaus_2016B.SetParameters(0.5,0.0,0.25)
tf1_singGaus_2016B.SetLineColor(kRed-5)
hist_2016B.Fit("tf1_singGaus_2016B","","",-0.6,0.6)
sigEff_2016B = 1000.0*tf1_singGaus_2016B.GetParameter(2)
meanEff_2016B = 1000.0*tf1_singGaus_2016B.GetParameter(1)

tf1_singGaus_2016C = TF1("tf1_singGaus_2016C","gaus(0)", -0.6,0.6)
tf1_singGaus_2016C.SetParameters(0.5,0.0,0.25)
tf1_singGaus_2016C.SetLineColor(kOrange-5)
hist_2016C.Fit("tf1_singGaus_2016C","","",-0.6,0.6)
sigEff_2016C = 1000.0*tf1_singGaus_2016C.GetParameter(2)
meanEff_2016C = 1000.0*tf1_singGaus_2016C.GetParameter(1)

tf1_singGaus_2016D = TF1("tf1_singGaus_2016D","gaus(0)", -0.6,0.6)
tf1_singGaus_2016D.SetParameters(0.5,0.0,0.25)
tf1_singGaus_2016D.SetLineColor(kYellow-5)
hist_2016D.Fit("tf1_singGaus_2016D","","",-0.6,0.6)
sigEff_2016D = 1000.0*tf1_singGaus_2016D.GetParameter(2)
meanEff_2016D = 1000.0*tf1_singGaus_2016D.GetParameter(1)

tf1_singGaus_2016E = TF1("tf1_singGaus_2016E","gaus(0)", -0.6,0.6)
tf1_singGaus_2016E.SetParameters(0.5,0.0,0.25)
tf1_singGaus_2016E.SetLineColor(kSpring-5)
hist_2016E.Fit("tf1_singGaus_2016E","","",-0.6,0.6)
sigEff_2016E = 1000.0*tf1_singGaus_2016E.GetParameter(2)
meanEff_2016E = 1000.0*tf1_singGaus_2016E.GetParameter(1)

tf1_singGaus_2016F = TF1("tf1_singGaus_2016F","gaus(0)", -0.6,0.6)
tf1_singGaus_2016F.SetParameters(0.5,0.0,0.25)
tf1_singGaus_2016F.SetLineColor(kGreen-5)
hist_2016F.Fit("tf1_singGaus_2016F","","",-0.6,0.6)
sigEff_2016F = 1000.0*tf1_singGaus_2016F.GetParameter(2)
meanEff_2016F = 1000.0*tf1_singGaus_2016F.GetParameter(1)

tf1_singGaus_2016G = TF1("tf1_singGaus_2016G","gaus(0)", -0.6,0.6)
tf1_singGaus_2016G.SetParameters(0.5,0.0,0.25)
tf1_singGaus_2016G.SetLineColor(kPink-5)
hist_2016G.Fit("tf1_singGaus_2016G","","",-0.6,0.6)
sigEff_2016G = 1000.0*tf1_singGaus_2016G.GetParameter(2)
meanEff_2016G = 1000.0*tf1_singGaus_2016G.GetParameter(1)

tf1_singGaus_2016H = TF1("tf1_singGaus_2016H","gaus(0)", -0.6,0.6)
tf1_singGaus_2016H.SetParameters(0.5,0.0,0.25)
tf1_singGaus_2016H.SetLineColor(kViolet-5)
hist_2016H.Fit("tf1_singGaus_2016H","","",-0.6,0.6)
sigEff_2016H = 1000.0*tf1_singGaus_2016H.GetParameter(2)
meanEff_2016H = 1000.0*tf1_singGaus_2016H.GetParameter(1)

tf1_singGaus_2016All = TF1("tf1_singGaus_2016All","gaus(0)", -0.6,0.6)
tf1_singGaus_2016All.SetParameters(0.5,0.0,0.25)
tf1_singGaus_2016All.SetLineColor(kBlue-5)
hist_2016All.Fit("tf1_singGaus_2016All","","",-0.6,0.6)
sigEff_2016All = 1000.0*tf1_singGaus_2016All.GetParameter(2)
meanEff_2016All = 1000.0*tf1_singGaus_2016All.GetParameter(1)


tf1_singGaus_2016MC = TF1("tf1_singGaus_2016MC","gaus(0)", -0.7,0.2)
tf1_singGaus_2016MC.SetParameters(0.5,-0.3,0.25)
tf1_singGaus_2016MC.SetLineColor(kBlack)
hist_2016MC.Fit("tf1_singGaus_2016MC","","",-0.7,0.2)
sigEff_2016MC = 1000.0*tf1_singGaus_2016MC.GetParameter(2)
meanEff_2016MC = 1000.0*tf1_singGaus_2016MC.GetParameter(1)


##legend
leg_mean = TLegend(0.62,0.45,0.85,0.9)
...
myC.SaveAs(outputDir+"/ZeeTiming/TimingShift_Data_vs_MC_2016.pdf")
myC.SaveAs(outputDir+"/ZeeTiming/TimingShift_Data_vs_MC_2016.png")
myC.SaveAs(outputDir+"/ZeeTiming/TimingShift_Data_vs_MC_2016.C")
