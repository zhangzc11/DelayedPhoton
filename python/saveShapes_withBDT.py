...
from config_withBDT import fileNameData, fileNameSig, fileNameGJets, fileNameQCD, cut_2J, cut_3J, splots, lumi, outputDir, xsecSig, xsecGJets, xsecQCD
from config_withBDT import scaleBkg
from config_withBDT import cut_GJets_shape_2J, cut_QCD_shape_2J, shapes
from config_withBDT import cut_GJets_shape_3J, cut_QCD_shape_3J
...
os.system("mkdir -p ../data_withBDT")
os.system("mkdir -p "+outputDir)
os.system("mkdir -p "+outputDir+"/shapes")
os.system("cp config_withBDT.py "+outputDir)
os.system("cp saveShapes_withBDT.py "+outputDir)
...
fileOut_2J = TFile("../data_withBDT/shapes_2J.root","RECREATE")
fileOut_2J.cd()
...
fileOut_3J = TFile("../data_withBDT/shapes_3J.root","RECREATE")
fileOut_3J.cd()
